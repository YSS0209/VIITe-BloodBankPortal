...
def donor_signup1_view(request):
    userForm=forms.DonorUserForm()
    donorForm=forms.DonorForm()
    mydict={'userForm':userForm,'donorForm':donorForm}
    if request.method=='POST':
        ...
        if userForm.is_valid() and donorForm.is_valid():
            ...
            my_donor_group[0].user_set.add(user)
        return HttpResponseRedirect('donorlogin')
    return render(request,'donor/A+.html',context=mydict)
def donor_signup2_view(request):
    userForm=forms.DonorUserForm()
    donorForm=forms.DonorForm()
    mydict={'userForm':userForm,'donorForm':donorForm}
    if request.method=='POST':
        ...
        return HttpResponseRedirect('donorlogin')
    return render(request,'donor/A-.html',context=mydict)
def donor_signup3_view(request):
    userForm=forms.DonorUserForm()
    donorForm=forms.DonorForm()
    mydict={'userForm':userForm,'donorForm':donorForm}
    if request.method=='POST':
        ...
        if userForm.is_valid() and donorForm.is_valid():
            ...
            my_donor_group[0].user_set.add(user)
        return HttpResponseRedirect('donorlogin')
    return render(request,'donor/B+.html',context=mydict)
def donor_signup4_view(request):
    userForm=forms.DonorUserForm()
    donorForm=forms.DonorForm()
    mydict={'userForm':userForm,'donorForm':donorForm}
    if request.method=='POST':
        ...
        return HttpResponseRedirect('donorlogin')
    return render(request,'donor/B-.html',context=mydict)
def donor_signup5_view(request):
    userForm=forms.DonorUserForm()
    donorForm=forms.DonorForm()
    mydict={'userForm':userForm,'donorForm':donorForm}
    if request.method=='POST':
        ...
        if userForm.is_valid() and donorForm.is_valid():
            ...
            my_donor_group[0].user_set.add(user)
        return HttpResponseRedirect('donorlogin')
    return render(request,'donor/AB+.html',context=mydict)
def donor_signup6_view(request):
    userForm=forms.DonorUserForm()
    donorForm=forms.DonorForm()
    mydict={'userForm':userForm,'donorForm':donorForm}
    if request.method=='POST':
        ...
        return HttpResponseRedirect('donorlogin')
    return render(request,'donor/AB-.html',context=mydict)
def donor_signup7_view(request):
    userForm=forms.DonorUserForm()
    donorForm=forms.DonorForm()
    mydict={'userForm':userForm,'donorForm':donorForm}
    if request.method=='POST':
        ...
        if userForm.is_valid() and donorForm.is_valid():
            ...
            my_donor_group[0].user_set.add(user)
        return HttpResponseRedirect('donorlogin')
    return render(request,'donor/O+.html',context=mydict)
def donor_signup8_view(request):
    userForm=forms.DonorUserForm()
    donorForm=forms.DonorForm()
    mydict={'userForm':userForm,'donorForm':donorForm}
    if request.method=='POST':
